...
<a href="/createAuthor"><h1 style="font-family: 'Arial Black'">Create authors</h1></a> <br><br><br><br><br><br><br>
<a href="/books"><h1 style="font-family: 'Arial Black'"> See All Books</h1></a> |
